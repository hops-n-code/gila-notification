...
@Service
@ConfigurationProperties("challenge.notifications.channels.push-notification")
@Slf4j
public class PushNotificationMessageChannel extends RetryableMessageChannel {
    private int maxAttempts = 3;
    private boolean useExponentialBackOff = true;

    @Override
    protected Boolean _sendMessage(MessageDTO messageDTO) {
        log.info("Sending Push Notification message: {}", messageDTO);
        return true;
    }
